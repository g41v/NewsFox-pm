...
function init()
{
	...
	var htmlRemove     = window.arguments[0].htmlRemove;
	...
	document.getElementById("htmlRemoveBox").value = htmlRemove;
	styleChange();
...
function doAccept()
{
	...
	window.arguments[0].htmlRemove = document.getElementById("htmlRemoveBox").value.replace(/ /gi,"");
